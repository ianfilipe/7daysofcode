...
function shopList() {
  for (i = 0; i >= 0; i++) {
    ...
    if (shopListResponse == 1) {
      foodListResponse = prompt('Qual comida você deseja inserir?')
      foodListCategory = prompt('Em qual categoria essa comida se encaixa? Digite "1" para "Frutas", "2" para  "Laticínios", "3" para "Congelados" e "4" para "Doces".')
